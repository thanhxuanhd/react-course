...
import { CardInfoState, GetCardInfo, ICardInfo } from "../core";

const initState: CardInfoState = {
  data: {
    ToDo: 0,
    Completed: 0,
    InProgess: 0,
...
export class InfoCard extends Component<unknown, CardInfoState> {
  state = {
    ...initState,
  };

  componentDidMount() {
    GetCardInfo().then((data: ICardInfo) => {
      this.setState({
        data: {
          ...data,
        },
  ...
  render() {
    return (
      <div className="info-card w-full">
        <div className="flex">
          <h3 className="font-bold text-xl p-4">Dashboard</h3>
        </div>
        <div className="flex">
            ...
            <div className="grid grid-cols-12 gap-4">
              ...
              <div className="col-span-12 sm:col-span-6 md:col-span-3">
                <div className="flex flex-row bg-white shadow-sm rounded p-4">
                  ...
                  <div className="flex flex-col flex-grow ml-4">
                    <div className="text-sm text-gray-500">InProgess</div>
                    <div className="font-bold text-lg">
                      {this.state.data.InProgess}
                    </div>
                  </div>
                </div>
              </div>
